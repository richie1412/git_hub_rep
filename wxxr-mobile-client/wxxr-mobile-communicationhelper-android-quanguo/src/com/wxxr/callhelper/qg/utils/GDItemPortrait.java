...
public class GDItemPortrait {
	...
	private static GDItemPortrait instance;

	private GDItemPortrait(Context mContext) {
		this.mContext = mContext;
	}

	public final static GDItemPortrait getInstance(Context mContext) {
		if (instance == null) {
			instance = new GDItemPortrait(mContext);
		}
		return instance;
	}

	public void setItemPortrait(String sms_name, String telphone,
			RelativeLayout rl, TextView tv, ImageView iv) {
