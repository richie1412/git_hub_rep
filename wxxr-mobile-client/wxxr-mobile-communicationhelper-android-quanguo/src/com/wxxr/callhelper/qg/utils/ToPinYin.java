...
public class ToPinYin {
	...
	static HashMap<String, String> duoyinzi = new HashMap<String, String>();
	static {
		duoyinzi.put("重", "chong");
	}
	...
	public static String getPinYin(String zhongwen)
		...
		if (zhongwen.equals("重庆")) {
			zhongWenPinYin = "CHONGQING";
		} else {
	...
	public static String getFirstPinyin(String str) {
		String pinYin = null;
		try {
			pinYin = getPinYin(str).substring(0, 1);
		} catch (BadHanyuPinyinOutputFormatCombination e) {
			e.printStackTrace();
		}
