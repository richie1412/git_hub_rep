...
public class Constant {
	//闪闪回信的存放文件夹
	public static final String APP_DATA_BASE = "sshxqg";
	
	public static final String GONG_YI_PIN_DAO = "KJSM";
	...
	public static final String PACKAGE_NAME = "com.wxxr.callhelper.qg";
	...
	public static final String DIALOG_PROVICE_TITLE = "provice";
	// 对话框key
	...
	public static final int CS_SETTING = 1277;
	public static final String CS_SETTING_KEY = "cs_setting_key";
	public static final String CS_NEED_SHOW = "cs_need_show";
	...
	public static final String MOBLE_APP_RECOMMEND = "app_recommend";
	...
	//业务类型
	public static final String QG_BUSINESS_TYPE = "business_type";
	
	//业务端口
	public static final String QG_BUSINESS_POST = "business_post";
	
	//业务代码
	public static final String QG_BUSINESS_CODE = "business_code";

	private static Map<String, String> provices = new HashMap<String, String>();

	// 标题有变化的省份
//	public static List<String> changeProviceLists = new ArrayList<String>();
//
//	static {
//		changeProviceLists.add("陕西");
//		changeProviceLists.add("山西");
//		changeProviceLists.add("广西");
//		changeProviceLists.add("贵州");
//	}
	
	// 图片和标题有变化的省份
	public static List<String> imgChangedProviceLists = new ArrayList<String>();
	
	static {
		imgChangedProviceLists.add("四川");
		imgChangedProviceLists.add("河北");
	}
