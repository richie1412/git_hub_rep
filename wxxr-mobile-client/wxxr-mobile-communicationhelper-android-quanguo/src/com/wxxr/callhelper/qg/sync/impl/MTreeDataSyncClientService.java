 ...
 * 
 */
package com.wxxr.callhelper.qg.sync.impl;

import com.wxxr.callhelper.qg.ComHelperAppContext;
import com.wxxr.callhelper.qg.sync.AbstractMTreeDataSyncClient;
 ...
 *
 */
public class MTreeDataSyncClientService extends AbstractMTreeDataSyncClient {
	private IMTreeDataSyncServerConnector connector;
	private ComHelperAppContext context;
	...
	public void init(ComHelperAppContext context){
		if (context == null) {
