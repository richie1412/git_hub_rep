...
public class MTreeNode {
	...
	/**
	 * method desc��set this parent node.
	 * 
	 * @param parent
	 */
	...
	public void addChild(MTreeNode child) {
		...
		// modify by chenfangyu 2013-6-7 �ڵ�ļ���˳�����Ҫ����Ϊ��Ӱ�츸�ڵ��hashֵ���㣬���뱣֤ͬ������ͬ���˳���Ҷ�ӽڵ�ÿ�ν����������ṹ�����ڵ�hashֵ��һ��ġ�
		if (children == null)
	...
	/**
	 * method desc�� Returns the number of children in this node.
	 * 
